...
!BOP
! !ROUTINE: noahmp401_map_veg
! \label{noahmp401_map_veg}
!
! !REVISION HISTORY:
! 22 Dec 2017: Sujay Kumar; Initial Specification
!
! !INTERFACE:
subroutine noahmp401_map_veg(n,k,OBS_State,LSM_Incr_State)
! !USES:
  use ESMF
...
!EOP
  ...
  real, allocatable            :: noahmp401_lai(:)

  allocate(noahmp401_lai(LIS_rc%npatch(n,LIS_rc%lsm_index)))
  ...
  do t=1,LIS_rc%npatch(n,LIS_rc%lsm_index)
     noahmp401_lai(t)  = noahmp401_struc(n)%noahmp401(t)%lai
  enddo
...
!  stop
  ...
  deallocate(noahmp401_lai)

end subroutine noahmp401_map_veg
