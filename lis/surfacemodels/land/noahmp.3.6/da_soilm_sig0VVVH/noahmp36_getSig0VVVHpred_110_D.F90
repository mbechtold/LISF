...
subroutine noahmp36_getSig0VVVHpred_110_D(n,k,obs_pred)
...
call LIS_RTM_run(n)
  ...
  call ESMF_StateGet(LIS_forwardState(n), "WCM_Sig0VV_110_D", varField, rc=status)
!LIS_histDAtaMod
...
!s0VV previously defined
  ...
  call ESMF_StateGet(LIS_forwardState(n), "WCM_Sig0VH_110_D", varField, rc=status)
  call LIS_verify(status, &
...
end subroutine noahmp36_getSig0VVVHpred_110_D
