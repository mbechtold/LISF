...
!BOP
! !ROUTINE: ac72_qc_Sig0VHobs
! \label{ac72_qc_Sig0VHobs}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine ac72_qc_Sig0VHobs(n,k,OBS_State)
! !USES:
  use ESMF
  use LIS_coreMod
...
!-----this part is derived from ./lis/dataassim/obs/s1_sigma/read_S1_sigma.F90
  ...
  call LIS_verify(status,&
       "ESMF_StateGet failed in ac72_qc_Sig0VHobs sigmaField")
...
end subroutine ac72_qc_Sig0VHobs
