...
!BOP
! !ROUTINE: ac72_getSig0VHpred
! \label{ac72_getSig0VHpred}
!
! !REVISION HISTORY:
...
subroutine ac72_getSig0VHpred(n,k,obs_pred)
...
!LIS_histDAtaMod
  call LIS_verify(status, &
       "Error in StateGet in ac72_getSig0VHPred for WCM_Sig0VH")

  call ESMF_FieldGet(varField, localDE=0,farrayPtr=s0VH, rc=status)!variable
!s0VH previously defined
  call LIS_verify(status, &
       'Error in FieldGet in ac72_getSig0VHPred for WCM_Sig0VH')
...
end subroutine ac72_getSig0VHpred
