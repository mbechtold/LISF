...
! !INTERFACE:
subroutine ac72_sfc2wcm(n, sfcState)
! !USES:      
  use ESMF
  use LIS_coreMod
...
!EOP
  ...
  do t=1,LIS_rc%npatch(n,LIS_rc%lsm_index)
     ...
     w3 = 0.1
     w1 = 1 - w2 - w3
     soil_moisture_content(t) = w1*AC72_struc(n)%ac72(t)%smc(1) + &
                                w2*AC72_struc(n)%ac72(t)%smc(2) + &
                                w3*AC72_struc(n)%ac72(t)%smc(3)
     Leaf_Area_Index(t) = AC72_struc(n)%ac72(t)%WCMV1V2
  enddo

end subroutine ac72_sfc2wcm
