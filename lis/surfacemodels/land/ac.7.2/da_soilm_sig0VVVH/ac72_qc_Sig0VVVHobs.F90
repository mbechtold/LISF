...
!BOP
! !ROUTINE: ac72_qc_Sig0obs
! \label{ac72_qc_Sig0obs}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine ac72_qc_Sig0VVVHobs(n,k,OBS_State)
! !USES:
  use ESMF
  use LIS_coreMod
...
end subroutine ac72_qc_Sig0VVVHobs
