...
!BOP
! !ROUTINE: ac72_getSig0VVVHpred
! \label{ac72_getSig0VVVHpred}
!
! !REVISION HISTORY:
...
subroutine ac72_getSig0VVVHpred(n,k,obs_pred)
...
end subroutine ac72_getSig0VVVHpred
