...
!BOP
! !ROUTINE: ac72_updatesoilmLAI
!  \label{ac72_updatesoilmLAI}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine ac72_updatesoilmLAI(n, LSM_State, LSM_Incr_State)
! !USES:
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
!EOP
  ...
  call LIS_verify(status,&
       "ESMF_StateGet: Soil Moisture Layer 1 failed in ac72_updatesoilmLAI")

  call ESMF_FieldGet(sm1Field,localDE=0,farrayPtr=soilm1,rc=status)
  call LIS_verify(status,&
       "ESMF_FieldGet: Soil Moisture Layer 1 failed in ac72_updatesoilmLAI")
  ...
  call LIS_verify(status,&
       "ESMF_StateGet: Soil Moisture Layer 2 failed in ac72_updatesoilmLAI")

  call ESMF_FieldGet(sm2Field,localDE=0,farrayPtr=soilm2,rc=status)
  call LIS_verify(status,&
       "ESMF_FieldGet: Soil Moisture Layer 2 failed in ac72_updatesoilmLAI")
  ...
  call LIS_verify(status,&
       "ESMF_StateGet: Soil Moisture Layer 3 failed in ac72_updatesoilmLAI")

  call ESMF_FieldGet(sm3Field,localDE=0,farrayPtr=soilm3,rc=status)
  call LIS_verify(status,&
       "ESMF_FieldGet: Soil Moisture Layer 3 failed in ac72_updatesoilmLAI")
...
end subroutine ac72_updatesoilmLAI
