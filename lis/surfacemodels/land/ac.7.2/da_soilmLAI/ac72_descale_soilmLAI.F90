...
!BOP
! !ROUTINE: ac72_descale_soilmLAI
! \label{ac72_descale_soilmLAI}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine ac72_descale_soilmLAI(n, LSM_State, LSM_Incr_State)
...
end subroutine ac72_descale_soilmLAI
