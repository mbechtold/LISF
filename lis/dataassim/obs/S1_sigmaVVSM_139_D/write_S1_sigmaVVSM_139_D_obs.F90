...
!BOP
! 
! !ROUTINE: write_S1_sigmaVVSM_139_D_obs
! \label{write_S1_sigmaVVSM_139_D_obs}
! 
! !REVISION HISTORY: 
! 30 Aug 2019: Hans Lievens; Initial Specification
! 
! !INTERFACE: 
subroutine write_S1_sigmaVVSM_139_D_obs(n, k, OBS_State)
! !USES: 
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call S1_sigmaVVSM_139_D_obsname(n,k,obsname)        
...
end subroutine write_S1_sigmaVVSM_139_D_obs

!BOP
! !ROUTINE: S1_sigmaVVSM_139_D_obsname
! \label{S1_sigmaVVSM_139_D_obsname}
! 
! !INTERFACE: 
subroutine S1_sigmaVVSM_139_D_obsname(n,k,obsname)
! !USES: 
...
end subroutine S1_sigmaVVSM_139_D_obsname
