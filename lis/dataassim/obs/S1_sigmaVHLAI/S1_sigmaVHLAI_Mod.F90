...
!BOP
! 
! !ROUTINE: S1_sigmaVHLAI_setup
! \label{S1_sigmaVHLAI_setup}
! 
! !INTERFACE: 
  subroutine S1_sigmaVHLAI_setup(k, OBS_State, OBS_Pert_State)
! !USES: 
...
!-------------------------------------------------------------
  ...
  end subroutine S1_sigmaVHLAI_setup
  
end module S1_sigmaVHLAI_Mod
