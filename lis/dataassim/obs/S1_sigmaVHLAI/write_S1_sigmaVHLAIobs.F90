...
!BOP
! 
! !ROUTINE: write_S1_sigmaVHLAIobs
! \label{write_S1_sigmaVHLAIobs}
! 
! !REVISION HISTORY: 
! 30 Aug 2019: Hans Lievens; Initial Specification
! 
! !INTERFACE: 
subroutine write_S1_sigmaVHLAIobs(n, k, OBS_State)
! !USES: 
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
!EOP
  ...
  if(data_update) then 
     ...
     if(LIS_masterproc) then 
        ...
        call S1_sigmaVHLAI_obsname(n,k,obsname)        
...
end subroutine write_S1_sigmaVHLAIobs

!BOP
! !ROUTINE: S1_sigmaVHLAI_obsname
! \label{S1_sigmaVHLAI_obsname}
! 
! !INTERFACE: 
subroutine S1_sigmaVHLAI_obsname(n,k,obsname)
! !USES: 
...
end subroutine S1_sigmaVHLAI_obsname
