...
!BOP
! 
! !ROUTINE: write_S1_sigmaVVVHSMLAI_139_D_obs
! \label{write_S1_sigmaVVVHSMLAI_139_D_obs}
! 
! !REVISION HISTORY: 
! 30 Aug 2019: Hans Lievens; Initial Specification
! 
! !INTERFACE: 
subroutine write_S1_sigmaVVVHSMLAI_139_D_obs(n, k, OBS_State)
! !USES: 
  use ESMF
  use LIS_coreMod
  use LIS_logMod
...
!    ! save VV
     if(LIS_masterproc) then 
        ...
        call S1_sigmaVVVHSMLAI_139_D_obsname(n,k,obsname_vv,obsname_vh)        
...
end subroutine write_S1_sigmaVVVHSMLAI_139_D_obs

!BOP
! !ROUTINE: S1_sigmaVVVHSMLAI_139_D_obsname
! \label{S1_sigmaVVVHSMLAI_139_D_obsname}
! 
! !INTERFACE: 
subroutine S1_sigmaVVVHSMLAI_139_D_obsname(n,k,obsname_vv,obsname_vh)
! !USES: 
...
!EOP
  ...
  obsname_vh = trim(LIS_rc%odir)//'/DAOBS/'//cdate1(1:6)//&
       '/LISDAOBS_VH_'//cdate1// &
       trim(cda)//trim(cdate)//'.1gs4r'  
end subroutine S1_sigmaVVVHSMLAI_139_D_obsname
