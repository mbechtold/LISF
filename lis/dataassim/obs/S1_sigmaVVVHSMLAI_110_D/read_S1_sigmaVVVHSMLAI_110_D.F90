...
#include "LIS_misc.h"
!BOP
! !ROUTINE: read_S1_sigmaVVVHSMLAI_110_D
! \label{read_S1_sigmaVVVHSMLAI_110_D}
!
! !REVISION HISTORY:
...
!
! !INTERFACE: 
subroutine read_S1_sigmaVVVHSMLAI_110_D(n,k,OBS_State,OBS_Pert_State) 
! !USES: 
  use ESMF
  use LIS_mpiMod
  use LIS_coreMod
  ...
  use LIS_pluginIndices, only : LIS_S1_sigmaVVVHSMLAI_110_D_obsId
  use S1_sigmaVVVHSMLAI_110_D_Mod, only : S1_sigma_struc
...
!-------------------------------------------------------------------------
  ...
  if(alarmCheck.or.S1_sigma_struc(n)%startMode) then 
     ...
     call S1_sigmaVVVHSMLAI_110_D_filename(S1_filename,obsdir,&
     ...
     if(file_exists) then 
        ...
        call read_S1_sigmaVVVHSMLAI_110_D_data(n,k, S1_filename, S1_sigma_struc(n)%s_vv, &
...
!-------------------------------------------------------------------------     
  ...
  call lsmdaqcobsstate(trim(LIS_rc%lsm)//"+"&
       //trim(LIS_S1_sigmaVVVHSMLAI_110_D_obsId)//char(0), & 
       n, k,OBS_state)
...
end subroutine read_S1_sigmaVVVHSMLAI_110_D



!BOP
!
! !ROUTINE: read_S1_sigmaVVVHSMLAI_110_D_data
! \label{read_S1_sigmaVVVHSMLAI_110_D_data}
!
! !INTERFACE:
subroutine read_S1_sigmaVVVHSMLAI_110_D_data(n, k, fname, svv_ip, svh_ip)
!
! !USES:
...
end subroutine read_S1_sigmaVVVHSMLAI_110_D_data



!BOP
!
! !ROUTINE: S1_sigmaVVVHSMLAI_110_D_filename
! \label{S1_SWND_filename}
! 
! !INTERFACE: 
subroutine S1_sigmaVVVHSMLAI_110_D_filename(filename, ndir, yr, mo, da)
...
end subroutine S1_sigmaVVVHSMLAI_110_D_filename
